...
export interface IAbreuLangError {
...
export default class AbreuLangErrorListener implements ANTLRErrorListener<any>{
    private errors: IAbreuLangError[] = []
